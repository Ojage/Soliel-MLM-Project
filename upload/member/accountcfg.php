                ...
                <form method="post" action="index.php" id="cfgform" oninput='password1.setCustomValidity(password2.value != password1.value ? "Passwords do not match." : "")'>
                            ...
                            <div class="tab-pane fade show active" id="cfgtab1" role="tabpanel" aria-labelledby="config-tab1">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="firstname" id="firstname" class="form-control" value="<?php echo isset($mbrstr['firstname']) ? $mbrstr['firstname'] : ''; ?>" placeholder="<?php echo myvalidate($LANG['m_userfirstname']); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><?php echo myvalidate($LANG['g_lastname']); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="lastname" id="lastname" class="form-control" value="<?php echo isset($mbrstr['lastname']) ? $mbrstr['lastname'] : ''; ?>" placeholder="<?php echo myvalidate($LANG['m_userlastname']); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" value="<?php echo isset($mbrstr['email']) ? $mbrstr['email'] : ''; ?>" placeholder="<?php echo myvalidate($LANG['m_useremail']); ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="selectgroup selectgroup-pills">
                                            <label class="selectgroup-item">
                                                ...
                                                <span class="selectgroup-button selectgroup-button-icon"><i class="fas fa-fw fa-times-circle"></i> <?php echo myvalidate($LANG['g_no']); ?></span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="optinme" value="1" class="selectgroup-input"<?php echo myvalidate($optinme_cek[1]); ?>>
                                                <span class="selectgroup-button selectgroup-button-icon"><i class="fas fa-fw fa-check-circle"></i> <?php echo myvalidate($LANG['g_yes']); ?></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer bg-whitesmoke text-md-right">
                        ...
                        <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary">
                            <i class="fa fa-fw fa-plus-circle"></i> <?php echo myvalidate($LANG['g_savechanges']); ?>
                        </button>

            ...
            <div class="card-footer bg-whitesmoke">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div>
                            <a href="javascript:;" data-href="doupfile.php?redir=digifile" data-poptitle="<i class='fa fa-fw fa-plus-circle'></i> Upload File" class="openPopup btn btn-secondary"><i class="fa fa-fw fa-upload"></i> Manual Upload</a>
                        </div>
                    </div>
                </div>
            </div>

                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <select name="langid" class="form-control select1">
                                ...
                                $langhit = 0;
                                if (!in_array('en.lang.php', $langfiles)) {
                                    ...
                                    echo "<option value='-'{$isdeflang_sel}>" . $isavallang_mark . $translation_str . $isdeflang_mark . "</option>";
                                }
            ...
            <div class="card">
                ...
                <form method="post" action="index.php" id="msgtplform">
                    ...
                    <div class="card-body">
                        ...
                        if ($langid == '-') {
                            $langid = 'en';
                            if (!file_exists($langdir . "/en.lang.php") && file_exists(INSTALL_PATH . "/common/en.lang.php")) {
                                copy(INSTALL_PATH . "/common/en.lang.php", $langdir . "/en.lang.php");
                                redirpageto('index.php?langid=en&hal=languagelist');
                                exit();
                            }
                        }
                        ...
                        if ($langid != '') {
                            ...
                            <div class="row">
                                ...
                                <?php
                                $misslang = array_diff_key($TEMPLANG, $LANG);
                                $LANG = array_merge($LANG, $misslang);
                                foreach ($LANG as $key => $value) {
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="alert alert-light text-muted text-small"><?php echo myvalidate($TEMPLANG[$key]); ?></div>
                        ...
                        <div class="card-footer bg-whitesmoke text-md-right">
                            <div class="form-group float-left text-left">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="isdeflang"><?php echo myvalidate($LANG['a_isdeflang']); ?></label>
                                </div>
                            </div>

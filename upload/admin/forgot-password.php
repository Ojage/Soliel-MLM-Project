...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    if ($email == $cfgrow['site_emailaddr']) {
        ...
        if ($getoutput['result'] == 1) {
            ...
            $_SESSION['show_msg'] = showalert('warning', 'Error', $getoutput['errmsg']);
        }
    } else {
